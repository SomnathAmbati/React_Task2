...
import Header from "../../task-2/src/Components/Header/Header";
import KeyPad from "../../task-2/src/Components/KeyPad/KeyPad";
...
function App() {
  ...
  const calculateResult = (exp) => {
    ...
    try {
      ...
      const formattedAnswer = parseFloat(answer).toFixed(2) + "";
